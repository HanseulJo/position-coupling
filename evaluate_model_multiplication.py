...
def evaluate(args):    
    ...
    for n_digits_1 in reversed(range(min_n_digits_1, max_n_digits_1+1, eval_step_digits_1)):
        ...
        for n_digits_2 in reversed(range(min_n_digits_2, max_n_digits_2+1, eval_step_digits_2)):
            try:
                ...
                print(f"#digits={n_digits_1} #operands={n_digits_2}  Loss {loss_avg:.6f} TokenAcc {tokenwise_accuracy_avg:.6f} InstAcc {instancewise_accuracy_avg:.6f}\n")
    ...
    # Save loggings
    n_digits_arr = list(range(min_n_digits_1, max_n_digits_1+1, eval_step_digits_1))
    n_operands_arr = list(range(min_n_digits_2, max_n_digits_2+1, eval_step_digits_2))
    perf_dict = {
        'n_digits_1': n_digits_arr,
        'n_digits_2': n_operands_arr,
        'losses': losses[::-1],
